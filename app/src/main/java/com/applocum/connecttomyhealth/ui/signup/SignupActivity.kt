...
class SignupActivity : BaseActivity(),SignupPresenter.View, PopupMenu.OnMenuItemClickListener,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnRegister.setOnClickListener {
         presenter.getSignup(etFirstName.text.toString(),etLastName.text.toString(),etEmail.text.toString(),"+"+countrycode+""+etPhoneNumber.text.toString(),etPassword.text.toString(),etConfirmPassword.text.toString(),etGender.text.toString().toLowerCase(
             Locale.ROOT), etDOB.text.toString())

...
data class User (
	...
	@SerializedName("days_left_for_current_password") val daysLeftForCurrentPassword : String,
	@SerializedName("password_expired") val passwordExpired : String,
	@SerializedName("password_expiry_due") val passwordExpiryDue : String,
	@SerializedName("is_account_locked") val is_accountLocked : Boolean,
